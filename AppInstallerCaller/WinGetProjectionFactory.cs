...
namespace AppInstallerCaller
{
    public static class WinGetProjectionFactory
    {
        ...
        public static InstallOptions CreateInstallOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static UninstallOptions CreateUninstallOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static FindPackagesOptions CreateFindPackagesOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static CreateCompositePackageCatalogOptions CreateCreateCompositePackageCatalogOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static PackageMatchFilter CreatePackageMatchFilter(bool useDev)
        {
            if (useDev)
            {
        ...
        public static InstallOptions TryCreateInstallOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static UninstallOptions TryCreateUninstallOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static FindPackagesOptions TryCreateFindPackagesOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static CreateCompositePackageCatalogOptions TryCreateCreateCompositePackageCatalogOptions(bool useDev)
        {
            if (useDev)
            {
        ...
        public static PackageMatchFilter TryCreatePackageMatchFilter(bool useDev)
        {
            if (useDev)
            {
        ...
        {
            Guid riid = typeof(T).GetInterfaces().FirstOrDefault().GUID;
            uint hresult = CoCreateInstance(ref rclsid, IntPtr.Zero, dwClsContext, ref riid, out var results);
            if (hresult != 0)
            {
        ...
        {
            Guid? iid = typeof(T)?.GetInterfaces()?.FirstOrDefault()?.GUID;
            if (!iid.HasValue)
            {
                return null;
            }
            Guid riid = iid.Value;
            _ = CoCreateInstance(ref rclsid, IntPtr.Zero, dwClsContext, ref riid, out var results);
        ...
        private unsafe static extern uint CoCreateInstance(
            [In] ref Guid rclsid,
            [In] IntPtr pUnkOuter,
